...
<div class="container">
	...
	<form action="" method="post">
		...
		<div class="field" tabindex="1">
			...
			<input name="titre" type="text" placeholder="e.g. abcd" class="form-control <?= (isset($error['titre'])) ? 'is-valid' : '' ?>">
		...
		<div class="field" tabindex="3">
			...
			<textarea name="message" placeholder="Ton Message" class="form-control <?= (isset($error['message'])) ? 'is-valid' : '' ?>"></textarea>
