...
<div class="container">
	...
	<form action="" method="post">
		...
		<div class="field" tabindex="1">
			...
			<input value="<?= htmlentities($_POST(['titre'] ?? '')) ?>" name="titre" type="text" placeholder="e.g. abcd" class="form-control <?= (isset($error['titre'])) ? 'is-invalid' : '' ?>">
		...
		<div class="field" tabindex="3">
			...
			<textarea name="message" placeholder="Ton Message" class="form-control <?= (isset($error['message'])) ? 'is-invalid' : '' ?>"><?= htmlentities($_POST(['message'] ?? '')) ?></textarea>
