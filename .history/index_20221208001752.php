	...
	if(!empty($_FILES['image']))
	{
		...
		if(in_array($typeFile, $type))
		{
			...
			if(count($extension) <= 2 && in_array(strtolower(end($extension)), $extensions))
			{
				...
				{
					echo '<center><h8 class="alert alert-danger">Fichier trop lourd ou format incorrect</center></h8>';
				}
			}
			else 
			{
				echo '<center><h8 class="alert alert-danger">Extension failed</center></h8>';
			}
		}   
		else 
		{
			echo '<center><h8 class="alert alert-danger">Type de image non autorisé</center></h8>';
		}
